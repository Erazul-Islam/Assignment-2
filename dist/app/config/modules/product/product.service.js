...
const getUpdatedProductFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedProduct = yield product_model_1.ProductModel.findOneAndUpdate({ _id: id }, payload, { new: true });
